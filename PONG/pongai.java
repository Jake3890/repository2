...
public class pongai implements ActionListener, KeyListener{
  //prop
  JFrame theframe;
  AnimationPanelpai thepanel;
  Timer thetimer;
  JLabel p1;
  JLabel p2;
  ...
  public void actionPerformed(ActionEvent evt){
    if(evt.getSource() == thetimer){
      ...
      if(thepanel.inty2<425){
        thepanel.inty2 = thepanel.intyb+15;
      }
      if(thepanel.inty2>0){
        thepanel.inty2 = thepanel.intyb-15;
      }
  ...
  //con
  public pongai(){
    thepanel = new AnimationPanelpai();
    ...
    theframe = new JFrame("pong v 1.0 with AI");
